...
import { ContainerContract } from "../../clients/components/ContainerContract";
...
export default function TableRecords({
  ...
  clients: IPaginationResponse<IClient>;
  ...
  return (
    <Card>
      <CardContent>
        ...
        >
          <SkeletonTable
            rows={clients.meta.perPage ? clients.meta.perPage : query.perPage}
          />
        </div>
      ...
      >
        <Pagination meta={clients.meta} query={query} refresh={refresh} />
      </CardFooter>
    </Card>
  );
}
