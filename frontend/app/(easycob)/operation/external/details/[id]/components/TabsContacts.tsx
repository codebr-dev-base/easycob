...
import { IContacts } from "../../../interfaces/contracts";
  ...
  return (
    <Tabs defaultValue="phones" className="w-full">
      ...
      <TabsContent value="phones">
        {/**
         * Abrir o formulário cadastro novo telefone
         */}
        <FormContactPhone
          contact={null}
          desContr={desContr}
      ...
      <TabsContent value="emails">
        {/**
         * Abrir o formulário cadastro novo email
         */}
        <FormContactEmail
          contact={null}
          desContr={desContr}
              ...
              {contacts.emails.map((email) => (
                <TableRow key={email.id} className={selectColor(email)}>
                  ...
                  <TableCell className="space-x-2">
                    ...
                    {/*                     <FormSendInvoice contact={email} desContr={desContr} >
                      <Button>
                        <RiMailSendFill />
                      </Button>
                    </FormSendInvoice> */}
