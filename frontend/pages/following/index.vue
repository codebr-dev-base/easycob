...
const handleChangePaginateNegotiation = async (e: any) => {
  ...
  listNegotiation.params.query.status = e.status;
...
const handleChangePaginateInvoice = async (e: any) => {
  ...
  listInvoices.params.query.status = e.status;
...
const handleChangePaginatePromise = async (e: any) => {
  ...
  if (
    ...
    listPromises.params.query.startDateCreate = e.searchDateCreate.start;
    listPromises.params.query.endDateCreate = e.searchDateCreate.end;
  } else {
    listPromises.params.query.startDateCreate = null;
    listPromises.params.query.endDateCreate = null;
  }

  listPromises.params.query.discount = e.discount;
  listPromises.params.query.status = e.status;
